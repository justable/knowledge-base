...
import {
  ...
  Ref,
  Deletion
} from '../../shared/react/ReactSideEffectTags'
...
import shallowEqual from '../../shared/react/shallowEqual'
import getComponentName from '../../shared/react/getComponentName'
import ReactStrictModeWarnings from './ReactStrictModeWarnings'
import { refineResolvedLazyComponent } from '../../shared/react/ReactLazyComponent'
...
function updateDehydratedSuspenseComponent(
  ...
  const suspenseInstance = workInProgress.stateNode
  if (current === null) {
